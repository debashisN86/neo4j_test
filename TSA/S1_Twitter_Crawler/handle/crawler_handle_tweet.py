...
logging.basicConfig(filename="crawler_handle_tweet.log", format='INFO %(asctime)s %(message)s', filemode='a')
# Creating an object
...
class twitterHelper:
    ...
    def getStreamTweets(self, userIdList):
        try:
            ...
            myStream.filter(follow=userIdList)
        except Exception, e:
...
if __name__ == '__main__':
    # get home directory....
    home_directory = os.environ['HOME']
    tweets_d = home_directory + "/Events/Master_Tweet_Json/handle_tweets/"

    t=twitterHelper()

    # get the track list from file if any...............................................................5
    userIdList = []
    fd1 = open('MTP_UserIds_v2', 'r')
    for line in fd1:
